...
export EXP=/scratch/SCWF00146/karina/1cbh_based_linear_binder_cellulose/02_rfd3_linear_symmetry_generation

export RFD3_ENV=/scratch/SCWF00146/karina/software/rfd3/envs/rfd3_venv_py312
export RFD3_PYTHON="$RFD3_ENV/bin/python"
export RFD3_BIN="$RFD3_ENV/bin/rfd3"
export RFD3_CKPT=/scratch/SCWF00146/karina/software/rfd3/checkpoints/rfd3_latest.ckpt
